...
def process_all_files(local_paths: Dict[str, str], spending_sheet_names: Optional[str] = None, dimension: str = "NSC_CODE") -> pl.DataFrame:
    ...
    summary_df = summary_df.with_columns(
        ...
        safe_div(pl.col("small_wheel_clicks_total"), pl.col("effective_live_sessions_total")).alias("avg_small_wheel_clicks_per_session"),
        safe_div(pl.col("small_wheel_clicks_t"), pl.col("effective_live_sessions_t")).alias("avg_small_wheel_clicks_per_session_t"),
        safe_div(pl.col("small_wheel_clicks_t_minus_1"), pl.col("effective_live_sessions_t_minus_1")).alias("avg_small_wheel_clicks_per_session_t_minus_1"),
    ...
    final_columns.extend([
        ...
        "avg_small_wheel_clicks_per_session", "avg_small_wheel_clicks_per_session_t", "avg_small_wheel_clicks_per_session_t_minus_1",
